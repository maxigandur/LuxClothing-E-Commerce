  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-md-4 footer-column">
        <ul className="nav flex-column">
          ...
          <li className="nav-item">
            <span className="nav-link"><i className="fas fa-phone"></i>+381 649 1095</span>
            <br/>
          </li>
          <li className="nav-item">
    ...
    <div className="row text-center">
      <div className="col-md-4 box">
        <span className="copyright quick-links">Copyright &copy; React E-Commerce By Max <script>document.write(new Date().getFullYear())</script>
        </span>
      </div>
      <div className="col-md-4 box">
